...
interface ProfileRepository {
    ...
    fun getPetsByUser(userId: String): kotlinx.coroutines.flow.Flow<List<Pet>>
    fun getAdoptionPetsByProtectora(userId: String): kotlinx.coroutines.flow.Flow<List<Pet>>
}